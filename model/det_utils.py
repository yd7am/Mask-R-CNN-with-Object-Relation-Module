...
class BoxCoder(object):
    ...
    def encode(self, reference_boxes, proposals):
        ...
        Args:
            ...
            proposals: List[Tensor] anchors/proposals 这里不是proposals是anchors
    ...
    def decode(self, rel_codes, boxes):
        ...
        """
        解码，根据预测偏差值和生成anchors(RPN)或proposals(Faster R-CNN)计算得到预测框
        Args:
            rel_codes: bbox regression parameters [-1,4]
            boxes: anchors/proposals [5*ANA_i, 4]*batch_size
        ...
        boxes_per_image = [b.size(0) for b in boxes]  # [5*ANA_i]*batch_size
        concat_boxes = torch.cat(boxes, dim=0)  # [-1,4]
...
class Matcher(object):
    ...
    def __init__(self, high_threshold, low_threshold, allow_low_quality_matches=False):
        ...
        self.allow_low_quality_matches = allow_low_quality_matches  # True
    ...
    def __call__(self, match_quality_matrix):
        ...
        # 正样本：1.与GT_boxes IOU最大的anchor（不满足IOU>high_theshould）
        # 正样本：1.每行IOU最大所对应的anchors 或 2.每列IOU最大并且IOU大于0.7对应的anchors
        if self.allow_low_quality_matches:
    ...
    def set_low_quality_matches_(self, matches, all_matches, match_quality_matrix):
        ...
        #           [    5, 45325],
        #           [    5, 46390]])
        # Each row is a (gt index, anchors index)
